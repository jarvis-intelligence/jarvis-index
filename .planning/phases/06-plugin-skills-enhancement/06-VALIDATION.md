...
| 06-03 T3 | 06-03 | 2 | D-03, SC-2 | T-06-08, T-06-18 | no cross-client parity claim; floors stay `>=` | content | `grep -c -F 'jarvis-mcp[semantic]>=0.9.1' plugin/README.md` | ✅ | ⬜ pending |
